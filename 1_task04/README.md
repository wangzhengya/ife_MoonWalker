...
实现如 示例图（[点击打开](http://wangzhengya.github.io/ife_MoonWalker/1_task04/task_1_4_1.jpg)） 的效果
...
* 动手试一试各种情况的组合，父元素和子元素分别取不同的 position 值。思考 position 属性各种取值的真正含义，尤其absolute 究竟是相对谁而言的。
